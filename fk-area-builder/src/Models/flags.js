...
module.exports = Object.freeze({
    ...
    JUSTICE_PUNISHMENTS: JUSTICE_PUNISHMENTS,
    META_VALUE_TYPES: META_VALUE_TYPES,
    META_VNUM_TYPES: META_VNUM_TYPES,
    MAGIC_ITEM_SPELLS: MAGIC_ITEM_SPELLS,
    ITEM_LAYERS: ITEM_LAYERS,
    WEAR_LOCATIONS: WEAR_LOCATIONS,
    ITEM_ATTRIBUTES: ITEM_ATTRIBUTES,
    ITEM_QUALITY: ITEM_QUALITY,
    ITEM_MATERIALS: ITEM_MATERIALS,
    ITEM_CONDITION: ITEM_CONDITION,
    ITEM_SIZES: ITEM_SIZES,
    ITEM_APPLIES: ITEM_APPLIES,
    ITEM_WEAPON_FLAGS: ITEM_WEAPON_FLAGS,
    ITEM_WEAPON_TYPES: ITEM_WEAPON_TYPES,
    ITEM_CONTAINER_FLAGS: ITEM_CONTAINER_FLAGS,
    ITEM_BODY_TYPES: ITEM_BODY_TYPES,
    ITEM_ARMOR_TYPES: ITEM_ARMOR_TYPES,
    ITEM_FURNITURE_STATES: ITEM_FURNITURE_STATES,
    ITEM_DRINK_TYPES: ITEM_DRINK_TYPES,
    ITEM_HERB_TYPES: ITEM_HERB_TYPES,
    ITEM_COIN_TYPES: ITEM_COIN_TYPES,
    ITEM_PIPE_FLAGS: ITEM_PIPE_FLAGS,
    LANGUAGE_FLAGS: LANGUAGE_FLAGS,
    ITEM_LEVER_BUTTON_FLAGS: ITEM_LEVER_BUTTON_FLAGS,
    TRAP_TYPES: TRAP_TYPES,
    TRAP_TRIGGERS: TRAP_TRIGGERS,
    ITEM_TYPES: ITEM_TYPES,
    EXIT_DIRECTIONS: EXIT_DIRECTIONS,
    EXIT_DOOR_FLAGS: EXIT_DOOR_FLAGS,
    EXIT_SIZES: EXIT_SIZES,
    ROOM_FLAGS: ROOM_FLAGS,
    ROOM_SECTOR_FLAGS: ROOM_SECTOR_FLAGS,
    MOB_CLASSES: MOB_CLASSES,
    MOB_RACES: MOB_RACES,
    MOB_SEXES: MOB_SEXES,
    MOB_POSITIONS: MOB_POSITIONS,
    MOB_DEITIES: MOB_DEITIES,
    MOB_ACT_FLAGS: MOB_ACT_FLAGS,
    MOB_AFFECTS: MOB_AFFECTS,
    MOB_ALIGNMENTS: MOB_ALIGNMENTS,
    MOB_RIS: MOB_RIS,
    MOB_SPELLS: MOB_SPELLS,
    MOB_SKILLS: MOB_SKILLS,
    MOB_WEAPON_SKILLS: MOB_WEAPON_SKILLS,
    MOB_LANGUAGES: MOB_LANGUAGES,
    MOB_STATISTICS: MOB_STATISTICS,
    MOB_FEATS: MOB_FEATS,
    MOB_BARDSONGS: MOB_BARDSONGS,
    MOB_TRADES: MOB_TRADES,
    MOB_KNOWLEDGE_SKILLS: MOB_KNOWLEDGE_SKILLS,
    MOB_REPAIR_MATERIAL: MOB_REPAIR_MATERIAL,
    MOB_REPAIR_RECHARGE: MOB_REPAIR_RECHARGE,
